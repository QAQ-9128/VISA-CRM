...
const FIN = {
  totalRows:32,
  receivables:[
    { name:'张伟', visa:'482', merged:true, billed:8000, received:6000, owe:2000, paid:2, total:3, next:{label:'律师费第 3 期', due:'6月15日到期'}, status:'待收', op:'记账', defaultOpen:false, stages:[
      { name:'文案费', per:2000, periods:1, billed:2000, received:2000, owe:0 },
      { name:'律师费', per:2000, periods:3, billed:6000, received:4000, owe:2000, inst:[
        { no:'第 1 期', amount:2000, due:'2025-03-01', status:'paid' },
        { no:'第 2 期', amount:2000, due:'2025-05-01', status:'paid' },
        { no:'第 3 期', amount:2000, due:'2025-07-01', status:'pending' },
      ] },
    ] },
    { name:'陈静', visa:'500', merged:true, billed:5000, received:2500, owe:2500, paid:1, total:3, next:{label:'第 2 期', overdue:'已逾期 5 天'}, status:'逾期', op:'跟进' },
    { name:'王强', visa:'186', merged:true, billed:12000, received:12000, owe:0, paid:3, total:3, next:null, status:'已结清', op:'查看' },
    { name:'周婷', visa:'482', merged:false, billed:6000, received:1500, owe:4500, paid:1, total:3, next:{label:'第 2 期', overdue:'逾期 2 天'}, status:'逾期', op:'记账' },
    { name:'孙佳琪', visa:'186', merged:true, billed:0, received:0, owe:0, paid:0, total:0, next:null, status:'未设应收', op:'设置' },
  ],
  totals:{ income:48600, expense:14000, net:34600 },
  installments:[
    { name:'陈静', visa:'500', no:'第 2 期', amount:2500, due:'2025-05-20', status:'overdue' },
    { name:'周婷', visa:'482', no:'尾款', amount:4500, due:'2025-06-30', status:'pending' },
    { name:'张伟', visa:'482', no:'第 2 期', amount:1200, due:'2025-07-01', status:'pending' },
    { name:'张伟', visa:'482', no:'第 1 期', amount:6800, due:'2025-05-01', status:'paid' },
    { name:'陈静', visa:'500', no:'第 1 期', amount:2500, due:'2025-04-15', status:'paid' },
    { name:'周婷', visa:'482', no:'首付', amount:1500, due:'2025-05-10', status:'paid' },
  ],
  receipts:[
