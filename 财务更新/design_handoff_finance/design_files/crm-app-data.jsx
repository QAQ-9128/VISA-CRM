...
const FIN = {
  totalRows:32,
  receivables:[
    { name:'张伟', visa:'482', merged:true, billed:8000, received:6000, owe:2000, color:'owe', defaultOpen:true, stages:[
    ...
    { name:'陈静', visa:'500', merged:true, billed:5000, received:2500, owe:2500, color:'owe' },
    { name:'王强', visa:'186', merged:true, billed:12000, received:12000, owe:0, color:'paid' },
    { name:'周婷', visa:'482', merged:false, billed:6000, received:1500, owe:4500, color:'owe' },
    { name:'孙佳琪', visa:'186', merged:true, billed:0, received:0, owe:0, color:'none' },
  ],
