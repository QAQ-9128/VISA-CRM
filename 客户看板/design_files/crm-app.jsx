...
const LODGE_ROWS = [
  ...
  {name:'李旻书',id:'84003712',sub:'',visa:'482',stream:'Core Skills',stage:'visa_lodged',nd:'2025-10-13',nm:null,nt:'已获批',vd:'2026-02-13',vm:3.6,vt:'3 个月 18 天'},
  ...
  {name:'郭琳娜',id:'31270578',sub:'',visa:'407',stream:'培训签',stage:'visa_lodged',nd:'2025-05-15',nm:null,nt:'已获批',vd:'2025-11-15',vm:6.6,vt:'6 个月 18 天'},
    ...
    <div className="card card-pad0" style={{overflow:'hidden'}}>
      <div className="ltwrap">
        <table className="ltbl">
          <thead>
            <tr>
              <th className="c-id" rowSpan={2}>案件编号</th>
              <th className="c-main" rowSpan={2}>主申请</th>
              <th rowSpan={2}>副申请</th>
              <th rowSpan={2}>签证类型</th>
              <th rowSpan={2}>状态</th>
              <th className="grp g-split" colSpan={2}>提名递交</th>
              <th className="grp v g-split" colSpan={2}>签证递交</th>
            </tr>
            <tr>
              <th className="g-split tn">递交时间</th><th className="tn">距今</th>
              <th className="g-split tv">递交时间</th><th className="tv">距今</th>
            </tr>
          </thead>
          <tbody>
            {LODGE_ROWS.map((r,i)=>{
...
function CustomersPage(){
  ...
  return (
    <AppShell active="#/customers" title="客户" sub="追踪并管理客户关系 · 按案件阶段查看销售渠道" actionLabel="新建客户" topSearch={false} width={view==='board'?'route-wide':'route-sm'}>
