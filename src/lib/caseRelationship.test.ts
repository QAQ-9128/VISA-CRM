...
const mkCase = (o: Partial<Case>): Case => ({
  ...
  destination_country: 'Australia', sponsor_position: null, sponsor_employer_id: null, assigned_to: null, created_by: null, is_archived: false, created_at: '', updated_at: '', ...o,
})
